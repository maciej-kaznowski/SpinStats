package com.github.maciej.kaznowski.intervalsicuclient.invoker.infrastructure

import com.github.maciej.kaznowski.intervalsicuclient.invoker.auth.HttpBasicAuth
import com.github.maciej.kaznowski.intervalsicuclient.invoker.auth.HttpBearerAuth
...
class ApiClient(
    ...
    companion object {
        @JvmStatic
        protected val baseUrlKey = "com.github.maciej.kaznowski.intervalsicuclient.invoker.baseUrl"

        @JvmStatic
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(baseUrlKey, "http://intervals.icu")
        }
    }
}
