...
data class ActivityWithIntervals (
    ...
    @Json(name = "gap_model")
    val gapModel: ActivityWithIntervals.GapModel? = null,
    ...
    @Json(name = "tiz_order")
    val tizOrder: ActivityWithIntervals.TizOrder? = null,
    ...
    @Json(name = "source")
    val source: ActivityWithIntervals.Source? = null,
    ...
    val hrLoadType: ActivityWithIntervals.HrLoadType? = null,

    @Json(name = "pace_load_type")
    val paceLoadType: ActivityWithIntervals.PaceLoadType? = null,
