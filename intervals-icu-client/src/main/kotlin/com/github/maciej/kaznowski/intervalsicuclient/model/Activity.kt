...
data class Activity (
    ...
    @Json(name = "gap_model")
    val gapModel: Activity.GapModel? = null,
    ...
    @Json(name = "tiz_order")
    val tizOrder: Activity.TizOrder? = null,
    ...
    @Json(name = "source")
    val source: Activity.Source? = null,
    ...
    val hrLoadType: Activity.HrLoadType? = null,

    @Json(name = "pace_load_type")
    val paceLoadType: Activity.PaceLoadType? = null,
